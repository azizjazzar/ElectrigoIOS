//
//  CategorieProduitViewModel.swift
//  Electrigo
//
//  Created by jazzar on 22/11/2023.
//

import Foundation


class CategorieProduitViewModel: ObservableObject {
    @Published var produits: [Produit] = []
  
 /*
    func getAll() {
        if let url = URL(string: "http://192.168.240.73:3000/api/product/products") {
