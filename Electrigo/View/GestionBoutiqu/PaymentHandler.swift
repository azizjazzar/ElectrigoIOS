...
class PaymentHandler: NSObject {
    ...
    func startPayment(products: [Produit], total: Float , completion: @escaping PaymentCompletionHandler) {
        ...
        products.forEach { product in
            let item = PKPaymentSummaryItem(label: product.nom, amount: NSDecimalNumber(string: "\(product.prix).00"), type: .final)
